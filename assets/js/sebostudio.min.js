if (!function(a, b) {
        ...
        for (var f, g, h, i, j, k, m, o = a.length, p = ca(b), q = [], r = 0; o > r; r++)
            ...
            g || 0 === g)
                if ("object" === n.type(g))
                    ...
                    for (i = i || p.appendChild(b.createElement("div")),
                    ...
                    for (n.merge(q, i.childNodes),
                    i.textContent = ""; i.firstChild; )
                        i.removeChild(i.firstChild);
                    i = p.lastChild
                } else
                    q.push(b.createTextNode(g));
        for (i && p.removeChild(i),
    ...
    var t = function(a) {
        ...
        for (b in {
            ...
            d.pseudos[b] = la(b);
        return oa.prototype = d.filters = d.pseudos,
        d.setFilters = new oa,
        ...
        i = ea.select = function(a, b, e, f) {
            ...
            1 === o.length) {
                ...
                for (i = W.needsContext.test(a) ? 0 : j.length; i-- && (k = j[i],
                !d.relative[l = k.type]); )
    ...
    n.fn.extend({
        ...
        empty: function() {
            for (var a, b = 0; null != (a = this[b]); b++) {
                for (1 === a.nodeType && n.cleanData(ea(a, !1)); a.firstChild; )
    ...
    var Ja, Ka = {
        HTML: "block",
        BODY: "block"
    }, Na = /^margin/, Oa = new RegExp("^(" + T + ")(?!px)[a-z%]+$","i"), Pa = function(a, b, c, d) {
        var e, f, g = {};
        for (f in b)
            g[f] = a.style[f],
            a.style[f] = b[f];
    ...
    n.fn.extend({
        ...
        offsetParent: function() {
            return this.map(function() {
                for (var a = this.offsetParent; a && !n.nodeName(a, "html") && "static" === n.css(a, "position"); )
                    a = a.offsetParent;
                return a || Qa
            })
        }
...
var sp = $(window).width() <= 1199 ? 0 : 22;
!function(a, b) {
    "function" == typeof define && define.amd ? define(b) : "object" == typeof exports ? module.exports = b() : a.GCCarousel = b()
}(this, function() {
    "use strict";
    var a = window._;
    return a || (a = {
    ...
    function(c) {
        function v() {
            u = t.querySelectorAll("li:not([data-gcc-ignore])"),
            k = document.createElement("div");
            for (var b = 0; b < e.length; b++)
                k.classList.add(e[b]);
            k.classList.add("grid-column-carousel__ref"),
            d.appendChild(k),
            x(),
            i && z(),
            t.classList.add("initialized"),
            window.addEventListener("resize", a.throttle(A, h, {
                leading: !0
            })),
            f && B()
        }
        ...
        function x() {
            l = k.getBoundingClientRect().width;
            for (var a = 0; a < u.length; a++)
                u[a].style.width = l + "px";
            n = parseInt(jQuery(d).parents(".row").width()),
            p = Math.ceil(u.length / (n / l))
        }
        function y(a) {
            for (var b = a.parentNode.childNodes, c = 0; c < b.length && a !== b[c]; c++)
                ;
            return c
        }
        function z() {
            for (; j.firstChild; )
                j.firstChild.removeEventListener("click", F),
                j.removeChild(j.firstChild);
            for (var a = 0; a < p; a++) {
                var b = document.createElement("li");
                b.classList.add("grid-column-carousel__page-indicator"),
                0 === a && b.classList.add("active"),
        ...
        function C(a) {
            o = a,
            t.style.WebkitTransform = "translateX(" + a + "px)",
            t.style.msTransform = "translateX(" + a + "px)",
            t.style.transform = "translateX(" + a + "px)"
        }
        function D(a) {
            a < 0 ? a = p - 1 : a >= p && (a = 0),
            i && (j.getElementsByClassName("active")[0].classList.remove("active"),
            j.getElementsByClassName("grid-column-carousel__page-indicator")[a].classList.add("active")),
            q = a,
            f && B(),
            C(0 === a ? 0 : a * n * -1)
        }
        ...
        var k, l, n, s, u, d = c.elem || null, e = (c.gridColClasses || "").split(" "), f = c.autoplay || !1, g = c.autoplayDelay || 5e3, h = c.throttleDelay || 50, i = "undefined" == typeof c.displayPageIndicators || c.displayPageIndicators, j = c.pageIndicatorsContainerElem || d.getElementsByClassName("grid-column-carousel__page-indicators")[0], m = null, o = 0, p = 0, q = 0, r = this, t = d.querySelector(".grid-column-carousel__list");
        v(),
        console.log(u),
        ...
        ,
        this.startWatchManualResize = function(a) {
            s = setInterval(A, h),
        ...
        ,
        this.recalculateSize = A,
        this.reinitialize = w
    }
});
var caseStudyCarousel, teamCarousel, uxCarousel, rwdCarousel, appsCarousel;
$(function() {
    var a = $(".case-study-items .grid-column-carousel");
    if (a.length) {
        var b = {
            elem: a[0],
        ...
        caseStudyCarousel = new GCCarousel(b)
    }
    var a = $(".team-items .grid-column-carousel");
    if (a.length) {
        var b = {
            elem: a[0],
            gridColClasses: "col-xs-12 col-sm-6 col-md-4 col-lg-3",
        ...
        teamCarousel = new GCCarousel(b)
    }
    var a = $(".ux-preview.grid-column-carousel");
    if (a.length) {
        var b = {
            elem: a[0],
            gridColClasses: "col-xs-12",
            autoplay: !1
        };
        uxCarousel = new GCCarousel(b)
    }
    var a = $(".rwd-preview.grid-column-carousel");
    if (a.length) {
        var b = {
            elem: a[0],
            gridColClasses: "col-xs-12",
        ...
        rwdCarousel = new GCCarousel(b)
    }
    var a = $(".apps-preview.grid-column-carousel");
    if (a.length) {
        var b = {
            elem: a[0],
            gridColClasses: "col-xs-12",
        ...
        appsCarousel = new GCCarousel(b)
    }
    $(".gc-control").on("click", function(a) {
        a.preventDefault();
        var b = $(this)
    ...
    $('.onepage-scroll[href*="#"]:not([href="#"])').on("click", function(a) {
        var b = $(this)
          , c = $(b.attr("href"));
        if (c.length)
            return a.preventDefault(),
            $("html, body").animate({
                scrollTop: c.offset().top - parseInt($("#header").css("padding-top"))
            }, 1e3),
            !1
    }),
    $(window).on("resize", function() {
        "undefined" != typeof caseStudyCarousel && caseStudyCarousel.reinitialize(),
        "undefined" != typeof teamCarousel && teamCarousel.reinitialize(),
        "undefined" != typeof uxCarousel && uxCarousel.reinitialize()
    }),
    $(window).scroll(function() {
        var a = $(window).scrollTop()
          , b = $(document).height() - $(window).height() - $("#footer").height() - 100;
        a > 100 && a < b ? $("#to-top").is(":hidden") && $("#to-top").fadeIn() : $("#to-top").is(":hidden") || $("#to-top").fadeOut()
    }).scroll()
});
